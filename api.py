...
async def anonymize_image(request: Request):
    try:
        ...
        # REVERTED to 320x320 to stop the ONNX crash (Model is hardcoded to 320)
        ...
        for row in preds:
            ...
            # KEEP THIS AT 0.20! This is what catches the background faces & distant plates
            if max_score > 0.20:
                x_c, y_c, w, h = row[0:4]
        ...
        # KEEP THIS AT 0.20 to match the threshold above
